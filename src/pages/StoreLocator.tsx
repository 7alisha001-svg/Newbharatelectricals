    ...
    <>
      ...
      <div className="w-full min-h-[80vh] bg-white">
        ...
        <section className="max-w-7xl mx-auto px-4 lg:px-6 py-12 md:py-20 grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          ...
          >
            <div className="inline-flex items-center text-xs font-bold tracking-widest uppercase bg-brand-green/10 text-brand-green px-4 py-2 rounded-full mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <a href="tel:+919457002000" className="flex items-center justify-center bg-gray-900 text-white py-3 px-6 rounded-2xl font-bold hover:bg-gray-800 transition-colors">
                <Phone size={18} className="mr-2" /> Call Now
              </a>
              <a href="https://wa.me/919457002000" target="_blank" rel="noreferrer" className="flex items-center justify-center bg-[#25D366] text-white py-3 px-6 rounded-2xl font-bold hover:bg-[#20bd5a] transition-colors">
                <MessageCircle size={18} className="mr-2" /> WhatsApp
              </a>
              <a href="https://www.google.com/maps/search/?api=1&query=Budaun+Uttar+Pradesh" target="_blank" rel="noreferrer" className="sm:col-span-2 flex items-center justify-center bg-white border-2 border-brand-green text-brand-green py-3 px-6 rounded-2xl font-bold hover:bg-brand-green hover:text-white transition-colors">
