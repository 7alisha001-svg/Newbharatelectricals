      ...
      <div className="max-w-[800px] mx-auto px-4 lg:px-8">
        ...
        >
          ...
          <div className="prose prose-gray max-w-none text-gray-900 font-medium space-y-6 md:space-y-8">
            ...
            <section>
              <h2 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4 uppercase tracking-wide">1. Introduction</h2>
            ...
            <section>
              <h2 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4 uppercase tracking-wide">2. Information We Collect</h2>
              <p className="leading-relaxed mb-3 text-sm md:text-base">To provide you with the best possible service, we collect the following types of information:</p>
            ...
            <section>
              <h2 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4 uppercase tracking-wide">3. How We Use Your Information</h2>
              <p className="leading-relaxed mb-3 text-sm md:text-base">Your information is strictly used to deliver and enhance our services. Specifically, we use it for:</p>
              <ul className="list-disc pl-5 space-y-2 text-sm md:text-base">
            ...
            <section>
              <h2 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4 uppercase tracking-wide">4. Cookies and Tracking Technologies</h2>
            ...
            <section>
              <h2 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4 uppercase tracking-wide">5. Sharing of Information with Third Parties</h2>
            ...
            <section>
              <h2 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4 uppercase tracking-wide">6. Data Security</h2>
              <p className="leading-relaxed text-sm md:text-base">
            ...
            <section>
              <h2 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4 uppercase tracking-wide">7. Customer Rights</h2>
              <p className="leading-relaxed mb-3 text-sm md:text-base">Depending on applicable laws in India, you have the right to:</p>
              <ul className="list-disc pl-5 space-y-2 text-sm md:text-base">
            ...
            <section>
              <h2 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4 uppercase tracking-wide">8. Data Retention</h2>
              <p className="leading-relaxed text-sm md:text-base">
            ...
            <section>
              <h2 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4 uppercase tracking-wide">9. Third-Party Links</h2>
              <p className="leading-relaxed text-sm md:text-base">
            ...
            <section>
              <h2 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4 uppercase tracking-wide">10. Children's Privacy</h2>
              <p className="leading-relaxed text-sm md:text-base">
            ...
            <section>
              <h2 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4 uppercase tracking-wide">11. Changes to This Privacy Policy</h2>
              <p className="leading-relaxed text-sm md:text-base">
            ...
            <section>
              <h2 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4 uppercase tracking-wide">12. Contact Information</h2>
              <p className="leading-relaxed text-sm md:text-base">
                If you have any questions or concerns about this Privacy Policy or our data practices, please contact us at:
              </p>
              <div className="mt-4 p-4 bg-gray-50 rounded-2xl border border-gray-100">
                <p className="mb-2 text-sm md:text-base"><strong>New Bharat Electricals</strong></p>
                ...
                <Link to="/contact" className="inline-block mt-4 text-brand-green font-bold hover:underline text-sm md:text-base">
                  Contact Us &rarr;
                </Link>
              </div>
            </section>
