      ...
      <div className="max-w-[1600px] mx-auto px-4 lg:px-6 xl:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-6">
          {brands.map((brand, idx) => (
            ...
            >
              <Link to={`/brands/${brand.slug}`} className="flex flex-col items-center group">
                <div className="w-full aspect-[4/3] bg-white rounded-xl overflow-hidden mb-2 sm:mb-4 border border-gray-200 shadow-sm group-hover:border-brand-green group-hover:shadow-md transition-all duration-300 relative flex items-center justify-center p-4">
                  <img 
