              ...
              <div className="flex flex-col md:flex-row items-center h-full pt-4 md:pt-0 pb-8 md:pb-0">
                ...
                <div className="w-full md:w-5/12 h-1/2 md:h-full relative flex flex-col items-center justify-end md:justify-center z-10 pb-4 md:pb-0">
                  ...
                  <div className="md:hidden mt-4 relative z-30">
                    <Link to={heroSlides[currentSlide].ctaLink} className="inline-block bg-gradient-to-b from-gray-700 to-gray-950 text-white font-black px-8 py-2.5 shadow-2xl hover:scale-105 transition-transform uppercase tracking-widest text-sm border border-gray-600/50">
                      {heroSlides[currentSlide].ctaText}
                    </Link>
                  </div>
